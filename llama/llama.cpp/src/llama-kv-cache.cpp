...
llama_kv_cache::llama_kv_cache(
    ...
    {
        const bool k_is_turbo = (type_k == GGML_TYPE_TURBO3_0 || type_k == GGML_TYPE_TURBO4_0 || type_k == GGML_TYPE_TURBO2_0 || type_k == GGML_TYPE_PLANAR3_0 || type_k == GGML_TYPE_ISO3_0 || type_k == GGML_TYPE_PLANAR4_0 || type_k == GGML_TYPE_ISO4_0);
        if (k_is_turbo) {
    ...
    for (uint32_t il = 0; il < hparams.n_layer; il++) {
        ...
        ggml_type layer_type_v = type_v;
        {
            ...
            const bool v_is_turbo = (type_v == GGML_TYPE_TURBO3_0 || type_v == GGML_TYPE_TURBO4_0 || type_v == GGML_TYPE_TURBO2_0 || type_v == GGML_TYPE_PLANAR3_0 || type_v == GGML_TYPE_ISO3_0 || type_v == GGML_TYPE_PLANAR4_0 || type_v == GGML_TYPE_ISO4_0);
        ...
        const bool k_is_turbo = (layer_type_k == GGML_TYPE_TURBO3_0 || layer_type_k == GGML_TYPE_TURBO4_0 || layer_type_k == GGML_TYPE_TURBO2_0 || layer_type_k == GGML_TYPE_PLANAR3_0 || layer_type_k == GGML_TYPE_ISO3_0 || layer_type_k == GGML_TYPE_PLANAR4_0 || layer_type_k == GGML_TYPE_ISO4_0);
        ...
        const bool v_is_turbo = (layer_type_v == GGML_TYPE_TURBO3_0 || layer_type_v == GGML_TYPE_TURBO4_0 || layer_type_v == GGML_TYPE_TURBO2_0 || layer_type_v == GGML_TYPE_PLANAR3_0 || layer_type_v == GGML_TYPE_ISO3_0 || layer_type_v == GGML_TYPE_PLANAR4_0 || layer_type_v == GGML_TYPE_ISO4_0);
        ...
        if (turbo_rotation == nullptr &&
            (type_k == GGML_TYPE_TURBO3_0 || type_k == GGML_TYPE_TURBO4_0 || type_k == GGML_TYPE_TURBO2_0 || type_k == GGML_TYPE_PLANAR3_0 || type_k == GGML_TYPE_ISO3_0 || type_k == GGML_TYPE_PLANAR4_0 || type_k == GGML_TYPE_ISO4_0)) {
